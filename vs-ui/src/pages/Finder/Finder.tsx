...
export const Finder: React.FC<{}> = () => {
    ...
    const handleChange = (text: FormEvent<HTMLElement>) => console.debug("Changed to: ", text);
    const handleSubmit = (text: FormEvent<HTMLElement>) => console.debug("Submitting: ", text);
